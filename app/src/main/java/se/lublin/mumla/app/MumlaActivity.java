...
public class MumlaActivity extends AppCompatActivity implements ListView.OnItemClickListener,
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        //canged by mkharma, don't show disconnect option
...
//                startActivity(prefIntent);
                PublicServerListHelper.showPreferences(this);
                return;
            default:
                return;
        }
    ...
    private void updateConnectionState(IHumlaService service) {
        ...
        switch (mService.getConnectionState()) {
            case CONNECTING:
                ...
                /* changed by mkharma, hide the ip*/

                mConnectingDialog.setMessage(getString(R.string.connecting_to_server, "police server"/*server.getHost()*/)
